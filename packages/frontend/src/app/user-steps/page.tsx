...
function StepOne() {
  ...
  return (
    <main className="h-screen flex justify-center items-center relative" onClick={handleNextStep} style={{ cursor: 'pointer' }}>      <div className="dashboard p-6 gap-4 w-[970px]  h-[870px] bg-nouns-pastel relative">
